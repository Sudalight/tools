...
func main() {
	...
	g := Generator{}
	g.parsePackage()
	g.Printf("// Code generated by \"github.com/Sudalight/tools/cmd/vslist\"; DO NOT EDIT.\n")
	g.Printf("// If something went wrong, re-run the \"vslist\" command to generate the file again.\n\n")
	...
	// Write to file.
	baseName := fmt.Sprintf("%s_string_list.go", strings.ToLower(types[0]))
...
func (g *Generator) generate(typeName string) {
	for i := range g.pkg.files {
		...
		g.Printf("var %sStringList = []string{\n", file.typeName)
